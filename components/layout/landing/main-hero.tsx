  ...
  return (
    <HeroHighlight className={'z-20'}>
      <motion.h1
        ...
        className="px-4 sm:px-0 text-3xl md:text-5xl lg:text-7xl font-bold text-neutral-700 dark:text-white max-w-4xl leading-relaxed lg:leading-snug text-left mx-auto "
      >
        {formatted}
      </motion.h1>
    </HeroHighlight>
