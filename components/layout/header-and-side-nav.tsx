...
export default async function HeaderAndSideNav({ lang }: HeaderAndSideNavProps) {
  ...
  return (
    <>
      <Alert className="bg-red-100 dark:bg-red-950 border-red-200 dark:border-red-900">
        <AlertDescription className="text-red-800 dark:text-red-200 text-center">
          ablaze.one is currently experiencing issues. We are working to resolve this as soon as possible.
        </AlertDescription>
      </Alert>
